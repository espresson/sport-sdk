...
//        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.Fullscreen);
        ...
        switch (mStyleColor) {
            ...
            case Blue:
                ...
                break;
            case Army:
                setStyle(DialogFragment.STYLE_NO_FRAME, R.style.StyleArmy);
                break;
            case Green:
            default:
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_udisk1, container, false);
    ...
    public void onCheckedSingle(View view, int position, boolean isChecked) {
        ...
        if(isChecked) this.position=position;
