...
public class UsbSdk extends MyObservable<UsbObserver> implements IUsbRootCallBackListener {
    ...
    private static UsbMonitorService.UsbMonitorServiceComm mUsbMonitorServiceComm;
    ...
    public static void registerUsbListener(UsbHelper.UsbListener usbListener) {
        if (null == usbSdk) {
            throw new NullPointerException("do you init the usb sdk");
        }
        UsbHelper.getInstance(usbSdk.app).registerUsbListener(usbListener);
    }

    public static void unRegisterUsbListener(UsbHelper.UsbListener usbListener) {
        if (null == usbSdk) {
            throw new NullPointerException("do you init the usb sdk");
        }
        UsbHelper.getInstance(usbSdk.app).unRegisterUsbListener(usbListener);
    }
