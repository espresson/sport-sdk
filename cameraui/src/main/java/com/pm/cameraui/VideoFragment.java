...
public class VideoFragment extends BaseCameraFragment implements DelegateCallback {
    ...
    public CameraController mController;
    public RecordDelegate mRecordDelegate;
   ...
   public static VideoFragment newInstance() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mController.setControllerCallback(new CameraController.ControllerCallback() {
            ...
            public void recordStart() {
                mController.resetCaptureLayout();
                mRecordDelegate.startRecordingVideo(SmartName);
            }
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            mTextureView.post(new Runnable() {
                @Override
                public void run() {
                    Log.e(";;;;;;;;",mTextureView.getWidth()+";;;;;;"+mTextureView.getHeight());
    ...
    public void onChangeViewSize(Size size) {
        ...
        Log.e("qqqqqqqq",size.getWidth()+";;;"+size.getHeight());
