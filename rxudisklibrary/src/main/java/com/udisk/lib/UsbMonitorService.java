...
public class UsbMonitorService extends Service implements UsbHelper.UsbListener, Application.ActivityLifecycleCallbacks {
    ...
    public void insertUsb(UsbDevice usbDevice) {
        if (null != mExcludeUsbDeviceImpl) {
            boolean flag = mExcludeUsbDeviceImpl.excludeUsbDevice(usbDevice);
            if (flag) {
                return;
            }
        }
    ...
    public class UsbMonitorServiceComm extends Binder {
        ...
        public void unregister() {
            ...
            UsbHelper.getInstance(UsbMonitorService.this).unregister();
        }

        public void registerUsbListener(UsbHelper.UsbListener usbListener) {
            UsbHelper.getInstance(UsbMonitorService.this).registerUsbListener(usbListener);
        }
    ...
    public void onCreate() {
        super.onCreate();
        UsbHelper.getInstance(UsbMonitorService.this).registerUsbListener(this);
    }
